var pingo = require('./controllers/pingo'),
    ...
    pantry = require('./controllers/pantry'),
...
module.exports = function(server) {
    ...
    server.get('/pingo/ingredients', pingo.ingredients);
    server.get('/continente/ingredients', continente.ingredients);
    server.post('/pantry/add',pantry.add);
    server.get('/pantry/get', pantry.get);
    server.post('/pantry/decrease',pantry.decrease);
    ...
    server.post('/account/remove', accounts.remove);
